						...
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-content">
									<h4 class="card-title">
										Properties booked for free visit
									</h4>
																	...
																	<thead>
																		<tr role="row">
																			...
																			<th  tabindex="0"
																				aria-controls="datatables" rowspan="1" colspan="1"
																				style="width: 150px;"
																				aria-label="Office: activate to sort column ascending">FreeVisit
																				Date & Time</th>
																	...
																	<tbody>
																		<c:forEach items="${freevisitList}" var="freevisit">
																			<tr role="row" class="odd">
																				<td tabindex="0" class="sorting_1">${freevisit.pname}</td>
																				<td>${freevisit.tname}</td>
																				<td>${freevisit.lname}</td>
