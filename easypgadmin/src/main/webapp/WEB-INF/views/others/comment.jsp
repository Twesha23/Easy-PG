                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th><a href="viewagency.jsp" style="color:black">Commentor</a></th>
                                    <th><a href="viewagency.jsp" style="color:black">Comment</a></th>
                                    <td class="td-actions text-right">
                                        
                                   
                                    	<a href="viewvisit.jsp">
                                        <button type="button" rel="tooltip" class="btn btn-info btn-simple" rel="tooltip" data-placement="bottom" title="View">
                                            <i class="material-icons">visibility</i>
                                        </button></a>
                                          <a href="viewreview.jsp">
                                        <button type="button" rel="tooltip" class="btn btn-info btn-simple" rel="tooltip" data-placement="bottom" title="View">
