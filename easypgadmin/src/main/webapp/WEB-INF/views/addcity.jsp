        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <form:form action="/easypgadmin/city/savecity" method="post" modelAttribute="city">
				<form:hidden path="city_id" name="city_id"/>
                     <form:input type="text" placeholder="city..." name="city_name" path="city_name"/>
                      <div class="col-sm-6">
                      <!-- select -->
                     
                       <div class="form-group">
                  <label>city</label>
                  <form:input type="text" name="city_name" path="city_name"  placeholder=" city..."/>
                </div>
                </div>
                    ...
                    <div class="material-datatables">
                        <div id="datatables_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"><div class="col-sm-6"></div><div class="col-sm-6"><div id="datatables_filter" class="dataTables_filter"></div></div></div></div><div class="row"><div class="col-sm-12"><table id="datatables" class="table table-striped table-no-bordered table-hover dataTable dtr-inline" cellspacing="0" width="100%" style="width: 100%;" role="grid" aria-describedby="datatables_info">
                            <thead>
                                <tr role="row">
                            ...
                            <tr role="row" class="odd">
                                    <td tabindex="0" class="sorting_1">${city.city_id}</td>
                                    <td>${city.city_name}</td>
                  
                                    <td class="td-actions text-right">
                                    	
                                        <a href="/easypgadmin/admin/editcity/${city.city_id}">
                                        <button type="button" rel="tooltip" class="btn btn-success btn-simple" rel="tooltip" data-placement="bottom" title="Edit">
                                            <i class="material-icons">edit</i>
                                        </button></a>
                                        <a href="/easypgadmin/admin/deletecity/${city.city_id}">
