...
<body class="off-canvas-sidebar">
  ...
  <!-- End Google Tag Manager (noscript) -->
    ...
    <div class="wrapper wrapper-full-page">
            <div class="full-page lock-page" filter-color="black" data-image="/EasyPG_Admin/demos.creative-tim.com/bs3/material-dashboard-pro/assets/img/lock.jpg">
            ...
            <form method="#" action="home.jsp">
                <div class="card card-profile card-hidden">
                    <div class="card-avatar">
                        <a href="#pablo">
                            <img class="avatar" src="/EasyPG_Admin/demos.creative-tim.com/bs3/material-dashboard-pro/assets/img/faces/avatar.jpg" alt="...">
                        </a>
                    </div>
