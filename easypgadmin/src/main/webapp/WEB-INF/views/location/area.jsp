                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
										<div class="checkbox" style="display:inline">
											<label>
												<input type="checkbox" name="optionsCheckboxes">Satellite
											</label>
										</div>
									</td>
                                ...
                                <tr>
                                    ...
                                    <td>
										<div class="checkbox" style="display:inline">
											<label>
												<input type="checkbox" name="optionsCheckboxes">Vastrapur
											</label>
										</div>
									</td>
									<td class="td-actions text-right">
                                ...
                                <tr>
                                    ...
                                    <td>
										<div class="checkbox" style="display:inline">
											<label>
												<input type="checkbox" name="optionsCheckboxes">Naranpura
											</label>
										</div>
									</td>
									<td class="td-actions text-right">
